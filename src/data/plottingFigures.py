...
plt.xscale('log')
plt.yscale('log')
plt.legend((r'Linearly evolved $ P_\delta^\mathrm{lin} $',r'Free non-linearly evolved $ \exp(Q_\mathrm{D}/2) \mathcal{P} $', r'Born approximated $ \bar{\mathcal{P}} $'), loc='lower left')
...
plt.xscale('log')
plt.yscale('log')
plt.legend((r'Free non-linearly evolved $\exp(Q_\mathrm{D}/2)  \mathcal{P} $', r'Born approximated $ \bar{\mathcal{P}} $'), loc='lower left')
plt.ylabel('Power spectra $[h^{-3}\,\mathrm{Mpc}^3 ]$')
...
ax2.set_xscale('log')
ax2.set_yscale('log')
ax1.legend((r'Born approximated $ \bar{\mathcal{P}} $',r'Free non-linearly evolved $\exp(Q_\mathrm{D}/2) \mathcal{P} $'), loc='lower left')
ax1.set_title(r'$\exp(Q_\mathrm{D}/2) \mathcal{P} $ and $ \bar{\mathcal{P}} $')
...
plt.xscale('log')
plt.yscale('log')
plt.legend((r'Free non-linearly evolved $ \exp(Q_\mathrm{D}/2) \mathcal{P} $', r'Born approximated $ \bar{\mathcal{P}} $'), loc='upper left')
plt.ylabel('Power spectra $[h^{-3}\,\mathrm{Mpc}^3 ]$')
plt.title(r'Gaussian power spectrum, $ a = %f  \\   k_0 = %f \, , \ \sigma = %f \  [h \, \mathrm{Mpc}^{-1} ] \ , $ ' %(a, k0,sigma,) )
